        ...
        footer: PlasmaExtras.PlasmoidHeading {
            ...
            ColumnLayout {
                ...
                Kirigami.InlineMessage {
                    ...
                    text: xi18nc("@info", "Use this feature only to temporarily boost audio volume in quiet videos; keeping it active all the time will eventually damage the device's speakers.")
                }
