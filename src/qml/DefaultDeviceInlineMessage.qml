...
Kirigami.InlineMessage {
    ...
    text: KI18n.xi18nc("@info", "Something went wrong while trying to determine the default audio devices. Please <link url='https://bugs.kde.org/enter_bug.cgi?product=plasmashell&component=Audio%20Volume%20widget'>open a bug report</link> with the output of <command>journalctl --user</command>. To resolve the situation you may need to log out and back in.")
