...
$XGETTEXT $(find . -name \*.cpp -o -name \*.h) -o "$podir"/kcm_pulseaudio.pot
...
$XGETTEXT --join-existing --language=JavaScript $(find . -name \*.qml -o -name \*.js) -o "$podir"/kcm_pulseaudio.pot
